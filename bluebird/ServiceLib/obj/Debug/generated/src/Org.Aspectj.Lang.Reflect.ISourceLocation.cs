...
namespace Org.Aspectj.Lang.Reflect {
	...
	public partial interface ISourceLocation : IJavaObject {
		...
		int Column {
			...
			[Register ("getColumn", "()I", "GetGetColumnHandler:Org.Aspectj.Lang.Reflect.ISourceLocationInvoker, ServiceLib")] get;
		}
		...
		string FileName {
			...
			[Register ("getFileName", "()Ljava/lang/String;", "GetGetFileNameHandler:Org.Aspectj.Lang.Reflect.ISourceLocationInvoker, ServiceLib")] get;
		}
		...
		int Line {
			...
			[Register ("getLine", "()I", "GetGetLineHandler:Org.Aspectj.Lang.Reflect.ISourceLocationInvoker, ServiceLib")] get;
		}
		...
		global::Java.Lang.Class WithinType {
			...
			[Register ("getWithinType", "()Ljava/lang/Class;", "GetGetWithinTypeHandler:Org.Aspectj.Lang.Reflect.ISourceLocationInvoker, ServiceLib")] get;
		}

	}

	[global::Android.Runtime.Register ("org/aspectj/lang/reflect/SourceLocation", DoNotGenerateAcw=true)]
	internal class ISourceLocationInvoker : global::Java.Lang.Object, ISourceLocation {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("org/aspectj/lang/reflect/SourceLocation", typeof (ISourceLocationInvoker));
...
#pragma warning disable 0169
		...
		{
			global::Org.Aspectj.Lang.Reflect.ISourceLocation __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.Reflect.ISourceLocation> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetGetWithinTypeHandler ()
		{
			if (cb_getWithinType == null)
				cb_getWithinType = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetWithinType);
