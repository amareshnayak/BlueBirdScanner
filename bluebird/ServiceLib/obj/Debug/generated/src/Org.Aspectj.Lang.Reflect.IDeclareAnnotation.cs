...
namespace Org.Aspectj.Lang.Reflect {
	...
	public sealed partial class DeclareAnnotationKind : global::Java.Lang.Enum {
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("org/aspectj/lang/reflect/DeclareAnnotation$Kind", typeof (DeclareAnnotationKind));
	...
	public partial interface IDeclareAnnotation : IJavaObject {
		...
		global::Java.Lang.Annotation.IAnnotation Annotation {
			...
			[Register ("getAnnotation", "()Ljava/lang/annotation/Annotation;", "GetGetAnnotationHandler:Org.Aspectj.Lang.Reflect.IDeclareAnnotationInvoker, ServiceLib")] get;
		}
		...
		string AnnotationAsText {
			...
			[Register ("getAnnotationAsText", "()Ljava/lang/String;", "GetGetAnnotationAsTextHandler:Org.Aspectj.Lang.Reflect.IDeclareAnnotationInvoker, ServiceLib")] get;
		}
		...
		global::Org.Aspectj.Lang.Reflect.IAjType DeclaringType {
			...
			[Register ("getDeclaringType", "()Lorg/aspectj/lang/reflect/AjType;", "GetGetDeclaringTypeHandler:Org.Aspectj.Lang.Reflect.IDeclareAnnotationInvoker, ServiceLib")] get;
		}
		...
		global::Org.Aspectj.Lang.Reflect.DeclareAnnotationKind Kind {
			...
			[Register ("getKind", "()Lorg/aspectj/lang/reflect/DeclareAnnotation$Kind;", "GetGetKindHandler:Org.Aspectj.Lang.Reflect.IDeclareAnnotationInvoker, ServiceLib")] get;
		}
		...
		global::Org.Aspectj.Lang.Reflect.ISignaturePattern SignaturePattern {
			...
			[Register ("getSignaturePattern", "()Lorg/aspectj/lang/reflect/SignaturePattern;", "GetGetSignaturePatternHandler:Org.Aspectj.Lang.Reflect.IDeclareAnnotationInvoker, ServiceLib")] get;
		}
		...
		global::Org.Aspectj.Lang.Reflect.ITypePattern TypePattern {
			...
			[Register ("getTypePattern", "()Lorg/aspectj/lang/reflect/TypePattern;", "GetGetTypePatternHandler:Org.Aspectj.Lang.Reflect.IDeclareAnnotationInvoker, ServiceLib")] get;
		}

	}

	[global::Android.Runtime.Register ("org/aspectj/lang/reflect/DeclareAnnotation", DoNotGenerateAcw=true)]
	internal class IDeclareAnnotationInvoker : global::Java.Lang.Object, IDeclareAnnotation {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("org/aspectj/lang/reflect/DeclareAnnotation", typeof (IDeclareAnnotationInvoker));
...
#pragma warning disable 0169
		...
		{
			global::Org.Aspectj.Lang.Reflect.IDeclareAnnotation __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.Reflect.IDeclareAnnotation> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetGetAnnotationAsTextHandler ()
		{
			if (cb_getAnnotationAsText == null)
				cb_getAnnotationAsText = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetAnnotationAsText);
...
#pragma warning disable 0169
		static Delegate GetGetSignaturePatternHandler ()
		{
			if (cb_getSignaturePattern == null)
				cb_getSignaturePattern = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetSignaturePattern);
...
#pragma warning disable 0169
		static Delegate GetGetTypePatternHandler ()
		{
			if (cb_getTypePattern == null)
				cb_getTypePattern = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetTypePattern);
