...
namespace Org.Aspectj.Runtime.Internal.Cflowstack {
	...
	public partial interface IThreadStack : IJavaObject {
		...
		global::Java.Util.Stack ThreadStack {
			...
			[Register ("getThreadStack", "()Ljava/util/Stack;", "GetGetThreadStackHandler:Org.Aspectj.Runtime.Internal.Cflowstack.IThreadStackInvoker, ServiceLib")] get;
		}
		...
		[Register ("removeThreadStack", "()V", "GetRemoveThreadStackHandler:Org.Aspectj.Runtime.Internal.Cflowstack.IThreadStackInvoker, ServiceLib")]
	...
	internal class IThreadStackInvoker : global::Java.Lang.Object, IThreadStack {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("org/aspectj/runtime/internal/cflowstack/ThreadStack", typeof (IThreadStackInvoker));
...
#pragma warning disable 0169
		static Delegate GetGetThreadStackHandler ()
		{
			if (cb_getThreadStack == null)
				cb_getThreadStack = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetThreadStack);
			return cb_getThreadStack;
		}

		static IntPtr n_GetThreadStack (IntPtr jnienv, IntPtr native__this)
		{
			global::Org.Aspectj.Runtime.Internal.Cflowstack.IThreadStack __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Runtime.Internal.Cflowstack.IThreadStack> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetRemoveThreadStackHandler ()
		{
			if (cb_removeThreadStack == null)
				cb_removeThreadStack = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr>) n_RemoveThreadStack);
