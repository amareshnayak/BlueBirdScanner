...
namespace Org.Aspectj.Lang.Reflect {
	...
	public partial interface IInterTypeMethodDeclaration : global::Org.Aspectj.Lang.Reflect.IInterTypeDeclaration {
		...
		global::Java.Lang.Reflect.IType GenericReturnType {
			...
			[Register ("getGenericReturnType", "()Ljava/lang/reflect/Type;", "GetGetGenericReturnTypeHandler:Org.Aspectj.Lang.Reflect.IInterTypeMethodDeclarationInvoker, ServiceLib")] get;
		}
		...
		string Name {
			...
			[Register ("getName", "()Ljava/lang/String;", "GetGetNameHandler:Org.Aspectj.Lang.Reflect.IInterTypeMethodDeclarationInvoker, ServiceLib")] get;
		}
		...
		global::Org.Aspectj.Lang.Reflect.IAjType ReturnType {
			...
			[Register ("getReturnType", "()Lorg/aspectj/lang/reflect/AjType;", "GetGetReturnTypeHandler:Org.Aspectj.Lang.Reflect.IInterTypeMethodDeclarationInvoker, ServiceLib")] get;
		}
		...
		[Register ("getExceptionTypes", "()[Lorg/aspectj/lang/reflect/AjType;", "GetGetExceptionTypesHandler:Org.Aspectj.Lang.Reflect.IInterTypeMethodDeclarationInvoker, ServiceLib")]
		...
		[Register ("getGenericParameterTypes", "()[Ljava/lang/reflect/Type;", "GetGetGenericParameterTypesHandler:Org.Aspectj.Lang.Reflect.IInterTypeMethodDeclarationInvoker, ServiceLib")]
		...
		[Register ("getParameterTypes", "()[Lorg/aspectj/lang/reflect/AjType;", "GetGetParameterTypesHandler:Org.Aspectj.Lang.Reflect.IInterTypeMethodDeclarationInvoker, ServiceLib")]
		...
		[Register ("getTypeParameters", "()[Ljava/lang/reflect/TypeVariable;", "GetGetTypeParametersHandler:Org.Aspectj.Lang.Reflect.IInterTypeMethodDeclarationInvoker, ServiceLib")]
	...
	internal class IInterTypeMethodDeclarationInvoker : global::Java.Lang.Object, IInterTypeMethodDeclaration {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("org/aspectj/lang/reflect/InterTypeMethodDeclaration", typeof (IInterTypeMethodDeclarationInvoker));
...
#pragma warning disable 0169
		static Delegate GetGetGenericReturnTypeHandler ()
		{
			if (cb_getGenericReturnType == null)
				cb_getGenericReturnType = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetGenericReturnType);
			return cb_getGenericReturnType;
		}

		static IntPtr n_GetGenericReturnType (IntPtr jnienv, IntPtr native__this)
		{
			global::Org.Aspectj.Lang.Reflect.IInterTypeMethodDeclaration __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.Reflect.IInterTypeMethodDeclaration> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetGetReturnTypeHandler ()
		{
			if (cb_getReturnType == null)
				cb_getReturnType = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetReturnType);
...
#pragma warning disable 0169
		static Delegate GetGetExceptionTypesHandler ()
		{
			if (cb_getExceptionTypes == null)
				cb_getExceptionTypes = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetExceptionTypes);
...
#pragma warning disable 0169
		static Delegate GetGetGenericParameterTypesHandler ()
		{
			if (cb_getGenericParameterTypes == null)
				cb_getGenericParameterTypes = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetGenericParameterTypes);
...
#pragma warning disable 0169
		static Delegate GetGetParameterTypesHandler ()
		{
			if (cb_getParameterTypes == null)
				cb_getParameterTypes = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetParameterTypes);
