...
namespace Org.Aspectj.Lang {
	...
	public partial class SoftException : global::Java.Lang.RuntimeException {
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("org/aspectj/lang/SoftException", typeof (SoftException));
...
#pragma warning disable 0169
		static Delegate GetGetWrappedThrowableHandler ()
		{
			if (cb_getWrappedThrowable == null)
				cb_getWrappedThrowable = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetWrappedThrowable);
			return cb_getWrappedThrowable;
		}

		static IntPtr n_GetWrappedThrowable (IntPtr jnienv, IntPtr native__this)
		{
			global::Org.Aspectj.Lang.SoftException __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.SoftException> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
