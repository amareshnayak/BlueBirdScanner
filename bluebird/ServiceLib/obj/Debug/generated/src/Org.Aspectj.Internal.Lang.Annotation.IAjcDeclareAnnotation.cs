...
namespace Org.Aspectj.Internal.Lang.Annotation {
	...
	public partial interface IAjcDeclareAnnotation : global::Java.Lang.Annotation.IAnnotation {
		...
		[Register ("annotation", "()Ljava/lang/String;", "GetAnnotationHandler:Org.Aspectj.Internal.Lang.Annotation.IAjcDeclareAnnotationInvoker, ServiceLib")]
		string Annotation ();
		...
		[Register ("kind", "()Ljava/lang/String;", "GetKindHandler:Org.Aspectj.Internal.Lang.Annotation.IAjcDeclareAnnotationInvoker, ServiceLib")]
		string Kind ();
		...
		[Register ("pattern", "()Ljava/lang/String;", "GetPatternHandler:Org.Aspectj.Internal.Lang.Annotation.IAjcDeclareAnnotationInvoker, ServiceLib")]
		string Pattern ();

	}

	[global::Android.Runtime.Register ("org/aspectj/internal/lang/annotation/ajcDeclareAnnotation", DoNotGenerateAcw=true)]
	internal class IAjcDeclareAnnotationInvoker : global::Java.Lang.Object, IAjcDeclareAnnotation {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("org/aspectj/internal/lang/annotation/ajcDeclareAnnotation", typeof (IAjcDeclareAnnotationInvoker));
...
#pragma warning disable 0169
		static Delegate GetAnnotationHandler ()
		{
			if (cb_annotation == null)
				cb_annotation = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_Annotation);
			return cb_annotation;
		}

		static IntPtr n_Annotation (IntPtr jnienv, IntPtr native__this)
		{
			global::Org.Aspectj.Internal.Lang.Annotation.IAjcDeclareAnnotation __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Internal.Lang.Annotation.IAjcDeclareAnnotation> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		...
		{
			if (cb_pattern == null)
				cb_pattern = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_Pattern);
			return cb_pattern;
		}
