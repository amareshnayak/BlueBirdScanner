...
namespace Org.Aspectj.Lang.Reflect {
	...
	public partial interface IAdviceSignature : global::Org.Aspectj.Lang.Reflect.ICodeSignature {
		...
		global::Java.Lang.Reflect.Method Advice {
			...
			[Register ("getAdvice", "()Ljava/lang/reflect/Method;", "GetGetAdviceHandler:Org.Aspectj.Lang.Reflect.IAdviceSignatureInvoker, ServiceLib")] get;
		}
		...
		global::Java.Lang.Class ReturnType {
			...
			[Register ("getReturnType", "()Ljava/lang/Class;", "GetGetReturnTypeHandler:Org.Aspectj.Lang.Reflect.IAdviceSignatureInvoker, ServiceLib")] get;
		}

	}

	[global::Android.Runtime.Register ("org/aspectj/lang/reflect/AdviceSignature", DoNotGenerateAcw=true)]
	internal class IAdviceSignatureInvoker : global::Java.Lang.Object, IAdviceSignature {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("org/aspectj/lang/reflect/AdviceSignature", typeof (IAdviceSignatureInvoker));
...
#pragma warning disable 0169
		static Delegate GetGetAdviceHandler ()
		{
			if (cb_getAdvice == null)
				cb_getAdvice = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetAdvice);
			return cb_getAdvice;
		}

		static IntPtr n_GetAdvice (IntPtr jnienv, IntPtr native__this)
		{
			global::Org.Aspectj.Lang.Reflect.IAdviceSignature __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.Reflect.IAdviceSignature> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetGetDeclaringTypeNameHandler ()
		{
			if (cb_getDeclaringTypeName == null)
				cb_getDeclaringTypeName = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetDeclaringTypeName);
