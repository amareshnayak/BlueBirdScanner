...
namespace Org.Aspectj.Runtime.Internal.Cflowstack {
	...
	public partial interface IThreadStackFactory : IJavaObject {
		...
		global::Org.Aspectj.Runtime.Internal.Cflowstack.IThreadCounter NewThreadCounter {
			...
			[Register ("getNewThreadCounter", "()Lorg/aspectj/runtime/internal/cflowstack/ThreadCounter;", "GetGetNewThreadCounterHandler:Org.Aspectj.Runtime.Internal.Cflowstack.IThreadStackFactoryInvoker, ServiceLib")] get;
		}
		...
		global::Org.Aspectj.Runtime.Internal.Cflowstack.IThreadStack NewThreadStack {
			...
			[Register ("getNewThreadStack", "()Lorg/aspectj/runtime/internal/cflowstack/ThreadStack;", "GetGetNewThreadStackHandler:Org.Aspectj.Runtime.Internal.Cflowstack.IThreadStackFactoryInvoker, ServiceLib")] get;
		}

	}

	[global::Android.Runtime.Register ("org/aspectj/runtime/internal/cflowstack/ThreadStackFactory", DoNotGenerateAcw=true)]
	internal class IThreadStackFactoryInvoker : global::Java.Lang.Object, IThreadStackFactory {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("org/aspectj/runtime/internal/cflowstack/ThreadStackFactory", typeof (IThreadStackFactoryInvoker));
...
#pragma warning disable 0169
		...
		{
			global::Org.Aspectj.Runtime.Internal.Cflowstack.IThreadStackFactory __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Runtime.Internal.Cflowstack.IThreadStackFactory> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
