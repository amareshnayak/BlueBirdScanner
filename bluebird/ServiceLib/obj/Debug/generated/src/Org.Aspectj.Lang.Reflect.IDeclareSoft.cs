...
namespace Org.Aspectj.Lang.Reflect {
	...
	public partial interface IDeclareSoft : IJavaObject {
		...
		global::Org.Aspectj.Lang.Reflect.IAjType DeclaringType {
			...
			[Register ("getDeclaringType", "()Lorg/aspectj/lang/reflect/AjType;", "GetGetDeclaringTypeHandler:Org.Aspectj.Lang.Reflect.IDeclareSoftInvoker, ServiceLib")] get;
		}
		...
		global::Org.Aspectj.Lang.Reflect.IPointcutExpression PointcutExpression {
			...
			[Register ("getPointcutExpression", "()Lorg/aspectj/lang/reflect/PointcutExpression;", "GetGetPointcutExpressionHandler:Org.Aspectj.Lang.Reflect.IDeclareSoftInvoker, ServiceLib")] get;
		}
		...
		global::Org.Aspectj.Lang.Reflect.IAjType SoftenedExceptionType {
			...
			[Register ("getSoftenedExceptionType", "()Lorg/aspectj/lang/reflect/AjType;", "GetGetSoftenedExceptionTypeHandler:Org.Aspectj.Lang.Reflect.IDeclareSoftInvoker, ServiceLib")] get;
		}

	}

	[global::Android.Runtime.Register ("org/aspectj/lang/reflect/DeclareSoft", DoNotGenerateAcw=true)]
	internal class IDeclareSoftInvoker : global::Java.Lang.Object, IDeclareSoft {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("org/aspectj/lang/reflect/DeclareSoft", typeof (IDeclareSoftInvoker));
...
#pragma warning disable 0169
		...
		{
			global::Org.Aspectj.Lang.Reflect.IDeclareSoft __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.Reflect.IDeclareSoft> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetGetSoftenedExceptionTypeHandler ()
		{
			if (cb_getSoftenedExceptionType == null)
				cb_getSoftenedExceptionType = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetSoftenedExceptionType);
