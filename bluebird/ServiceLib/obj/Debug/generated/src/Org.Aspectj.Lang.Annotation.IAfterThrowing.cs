...
namespace Org.Aspectj.Lang.Annotation {
	...
	public partial interface IAfterThrowing : global::Java.Lang.Annotation.IAnnotation {
		...
		[Register ("argNames", "()Ljava/lang/String;", "GetArgNamesHandler:Org.Aspectj.Lang.Annotation.IAfterThrowingInvoker, ServiceLib")]
		string ArgNames ();
		...
		[Register ("pointcut", "()Ljava/lang/String;", "GetPointcutHandler:Org.Aspectj.Lang.Annotation.IAfterThrowingInvoker, ServiceLib")]
		string Pointcut ();
		...
		[Register ("throwing", "()Ljava/lang/String;", "GetThrowingHandler:Org.Aspectj.Lang.Annotation.IAfterThrowingInvoker, ServiceLib")]
		string Throwing ();
		...
		[Register ("value", "()Ljava/lang/String;", "GetValueHandler:Org.Aspectj.Lang.Annotation.IAfterThrowingInvoker, ServiceLib")]
		string Value ();

	}

	[global::Android.Runtime.Register ("org/aspectj/lang/annotation/AfterThrowing", DoNotGenerateAcw=true)]
	internal class IAfterThrowingInvoker : global::Java.Lang.Object, IAfterThrowing {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("org/aspectj/lang/annotation/AfterThrowing", typeof (IAfterThrowingInvoker));
...
#pragma warning disable 0169
		...
		{
			global::Org.Aspectj.Lang.Annotation.IAfterThrowing __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.Annotation.IAfterThrowing> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		...
		{
			if (cb_throwing == null)
				cb_throwing = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_Throwing);
			return cb_throwing;
		}
