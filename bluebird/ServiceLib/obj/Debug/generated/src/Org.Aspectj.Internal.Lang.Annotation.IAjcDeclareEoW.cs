...
namespace Org.Aspectj.Internal.Lang.Annotation {
	...
	public partial interface IAjcDeclareEoW : global::Java.Lang.Annotation.IAnnotation {
		...
		bool IsError {
			...
			[Register ("isError", "()Z", "GetIsErrorHandler:Org.Aspectj.Internal.Lang.Annotation.IAjcDeclareEoWInvoker, ServiceLib")] get;
		}
		...
		[Register ("message", "()Ljava/lang/String;", "GetMessageHandler:Org.Aspectj.Internal.Lang.Annotation.IAjcDeclareEoWInvoker, ServiceLib")]
		string Message ();
		...
		[Register ("pointcut", "()Ljava/lang/String;", "GetPointcutHandler:Org.Aspectj.Internal.Lang.Annotation.IAjcDeclareEoWInvoker, ServiceLib")]
		string Pointcut ();

	}

	[global::Android.Runtime.Register ("org/aspectj/internal/lang/annotation/ajcDeclareEoW", DoNotGenerateAcw=true)]
	internal class IAjcDeclareEoWInvoker : global::Java.Lang.Object, IAjcDeclareEoW {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("org/aspectj/internal/lang/annotation/ajcDeclareEoW", typeof (IAjcDeclareEoWInvoker));
...
#pragma warning disable 0169
		...
		{
			global::Org.Aspectj.Internal.Lang.Annotation.IAjcDeclareEoW __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Internal.Lang.Annotation.IAjcDeclareEoW> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
