...
namespace Org.Aspectj.Runtime.Internal.Cflowstack {
	...
	public partial interface IThreadCounter : IJavaObject {
		...
		bool IsNotZero {
			...
			[Register ("isNotZero", "()Z", "GetIsNotZeroHandler:Org.Aspectj.Runtime.Internal.Cflowstack.IThreadCounterInvoker, ServiceLib")] get;
		}
		...
		[Register ("dec", "()V", "GetDecHandler:Org.Aspectj.Runtime.Internal.Cflowstack.IThreadCounterInvoker, ServiceLib")]
		void Dec ();
		...
		[Register ("inc", "()V", "GetIncHandler:Org.Aspectj.Runtime.Internal.Cflowstack.IThreadCounterInvoker, ServiceLib")]
		void Inc ();
		...
		[Register ("removeThreadCounter", "()V", "GetRemoveThreadCounterHandler:Org.Aspectj.Runtime.Internal.Cflowstack.IThreadCounterInvoker, ServiceLib")]
	...
	internal class IThreadCounterInvoker : global::Java.Lang.Object, IThreadCounter {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("org/aspectj/runtime/internal/cflowstack/ThreadCounter", typeof (IThreadCounterInvoker));
...
#pragma warning disable 0169
		static Delegate GetIsNotZeroHandler ()
		{
			if (cb_isNotZero == null)
				cb_isNotZero = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, bool>) n_IsNotZero);
			return cb_isNotZero;
		}

		static bool n_IsNotZero (IntPtr jnienv, IntPtr native__this)
		{
			global::Org.Aspectj.Runtime.Internal.Cflowstack.IThreadCounter __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Runtime.Internal.Cflowstack.IThreadCounter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		...
		{
			if (cb_dec == null)
				cb_dec = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr>) n_Dec);
			return cb_dec;
		}
...
#pragma warning disable 0169
		...
		{
			if (cb_inc == null)
				cb_inc = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr>) n_Inc);
			return cb_inc;
		}
...
#pragma warning disable 0169
		static Delegate GetRemoveThreadCounterHandler ()
		{
			if (cb_removeThreadCounter == null)
				cb_removeThreadCounter = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr>) n_RemoveThreadCounter);
