...
namespace Org.Aspectj.Lang.Reflect {
	...
	public partial interface IDeclareErrorOrWarning : IJavaObject {
		...
		global::Org.Aspectj.Lang.Reflect.IAjType DeclaringType {
			...
			[Register ("getDeclaringType", "()Lorg/aspectj/lang/reflect/AjType;", "GetGetDeclaringTypeHandler:Org.Aspectj.Lang.Reflect.IDeclareErrorOrWarningInvoker, ServiceLib")] get;
		}
		...
		bool IsError {
			...
			[Register ("isError", "()Z", "GetIsErrorHandler:Org.Aspectj.Lang.Reflect.IDeclareErrorOrWarningInvoker, ServiceLib")] get;
		}
		...
		string Message {
			...
			[Register ("getMessage", "()Ljava/lang/String;", "GetGetMessageHandler:Org.Aspectj.Lang.Reflect.IDeclareErrorOrWarningInvoker, ServiceLib")] get;
		}
		...
		global::Org.Aspectj.Lang.Reflect.IPointcutExpression PointcutExpression {
			...
			[Register ("getPointcutExpression", "()Lorg/aspectj/lang/reflect/PointcutExpression;", "GetGetPointcutExpressionHandler:Org.Aspectj.Lang.Reflect.IDeclareErrorOrWarningInvoker, ServiceLib")] get;
		}

	}

	[global::Android.Runtime.Register ("org/aspectj/lang/reflect/DeclareErrorOrWarning", DoNotGenerateAcw=true)]
	internal class IDeclareErrorOrWarningInvoker : global::Java.Lang.Object, IDeclareErrorOrWarning {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("org/aspectj/lang/reflect/DeclareErrorOrWarning", typeof (IDeclareErrorOrWarningInvoker));
...
#pragma warning disable 0169
		...
		{
			global::Org.Aspectj.Lang.Reflect.IDeclareErrorOrWarning __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.Reflect.IDeclareErrorOrWarning> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
