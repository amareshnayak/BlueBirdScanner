...
namespace Org.Aspectj.Lang.Reflect {
	...
	public partial interface IDeclareParents : IJavaObject {
		...
		global::Org.Aspectj.Lang.Reflect.IAjType DeclaringType {
			...
			[Register ("getDeclaringType", "()Lorg/aspectj/lang/reflect/AjType;", "GetGetDeclaringTypeHandler:Org.Aspectj.Lang.Reflect.IDeclareParentsInvoker, ServiceLib")] get;
		}
		...
		bool IsExtends {
			...
			[Register ("isExtends", "()Z", "GetIsExtendsHandler:Org.Aspectj.Lang.Reflect.IDeclareParentsInvoker, ServiceLib")] get;
		}
		...
		bool IsImplements {
			...
			[Register ("isImplements", "()Z", "GetIsImplementsHandler:Org.Aspectj.Lang.Reflect.IDeclareParentsInvoker, ServiceLib")] get;
		}
		...
		global::Org.Aspectj.Lang.Reflect.ITypePattern TargetTypesPattern {
			...
			[Register ("getTargetTypesPattern", "()Lorg/aspectj/lang/reflect/TypePattern;", "GetGetTargetTypesPatternHandler:Org.Aspectj.Lang.Reflect.IDeclareParentsInvoker, ServiceLib")] get;
		}
		...
		[Register ("getParentTypes", "()[Ljava/lang/reflect/Type;", "GetGetParentTypesHandler:Org.Aspectj.Lang.Reflect.IDeclareParentsInvoker, ServiceLib")]
	...
	internal class IDeclareParentsInvoker : global::Java.Lang.Object, IDeclareParents {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("org/aspectj/lang/reflect/DeclareParents", typeof (IDeclareParentsInvoker));
...
#pragma warning disable 0169
		...
		{
			global::Org.Aspectj.Lang.Reflect.IDeclareParents __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.Reflect.IDeclareParents> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetIsExtendsHandler ()
		{
			if (cb_isExtends == null)
				cb_isExtends = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, bool>) n_IsExtends);
			return cb_isExtends;
		}
...
#pragma warning disable 0169
		static Delegate GetIsImplementsHandler ()
		{
			if (cb_isImplements == null)
				cb_isImplements = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, bool>) n_IsImplements);
...
#pragma warning disable 0169
		static Delegate GetGetTargetTypesPatternHandler ()
		{
			if (cb_getTargetTypesPattern == null)
				cb_getTargetTypesPattern = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetTargetTypesPattern);
...
#pragma warning disable 0169
		static Delegate GetGetParentTypesHandler ()
		{
			if (cb_getParentTypes == null)
				cb_getParentTypes = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetParentTypes);
