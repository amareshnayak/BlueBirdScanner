...
namespace Org.Aspectj.Internal.Lang.Annotation {
	...
	public partial interface IAjcDeclareParents : global::Java.Lang.Annotation.IAnnotation {
		...
		bool IsExtends {
			...
			[Register ("isExtends", "()Z", "GetIsExtendsHandler:Org.Aspectj.Internal.Lang.Annotation.IAjcDeclareParentsInvoker, ServiceLib")] get;
		}
		...
		[Register ("parentTypes", "()Ljava/lang/String;", "GetParentTypesHandler:Org.Aspectj.Internal.Lang.Annotation.IAjcDeclareParentsInvoker, ServiceLib")]
		string ParentTypes ();
		...
		[Register ("targetTypePattern", "()Ljava/lang/String;", "GetTargetTypePatternHandler:Org.Aspectj.Internal.Lang.Annotation.IAjcDeclareParentsInvoker, ServiceLib")]
	...
	internal class IAjcDeclareParentsInvoker : global::Java.Lang.Object, IAjcDeclareParents {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("org/aspectj/internal/lang/annotation/ajcDeclareParents", typeof (IAjcDeclareParentsInvoker));
...
#pragma warning disable 0169
		...
		{
			global::Org.Aspectj.Internal.Lang.Annotation.IAjcDeclareParents __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Internal.Lang.Annotation.IAjcDeclareParents> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetParentTypesHandler ()
		{
			if (cb_parentTypes == null)
				cb_parentTypes = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_ParentTypes);
...
#pragma warning disable 0169
		static Delegate GetTargetTypePatternHandler ()
		{
			if (cb_targetTypePattern == null)
				cb_targetTypePattern = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_TargetTypePattern);
