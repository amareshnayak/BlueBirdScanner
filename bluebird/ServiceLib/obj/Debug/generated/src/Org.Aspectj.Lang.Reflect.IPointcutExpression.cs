...
namespace Org.Aspectj.Lang.Reflect {
	...
	public partial interface IPointcutExpression : IJavaObject {
		...
		[Register ("asString", "()Ljava/lang/String;", "GetAsStringHandler:Org.Aspectj.Lang.Reflect.IPointcutExpressionInvoker, ServiceLib")]
		string AsString ();

	}

	[global::Android.Runtime.Register ("org/aspectj/lang/reflect/PointcutExpression", DoNotGenerateAcw=true)]
	internal class IPointcutExpressionInvoker : global::Java.Lang.Object, IPointcutExpression {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("org/aspectj/lang/reflect/PointcutExpression", typeof (IPointcutExpressionInvoker));
...
#pragma warning disable 0169
		...
		{
			global::Org.Aspectj.Lang.Reflect.IPointcutExpression __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.Reflect.IPointcutExpression> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
